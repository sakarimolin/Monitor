...
//            string ComStr = Settings1.Equals();
        ...
        private string carName = "initial";
        ...
        public void CarNameInit(String name)
        {
            carName = name;
            carTextBox.Text = carName;
        }

        public string CarNameRead()
        {
            return carName;
        }
        ...
        private void carTextBox_ModifiedChanged(object sender, EventArgs e)
        {
            carName = sender.ToString();
        }
    }
}
