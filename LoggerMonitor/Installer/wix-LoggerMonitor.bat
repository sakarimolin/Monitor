...
call "C:\Program Files (x86)\WiX Toolset v3.14\bin\Candle.exe" ^
-dLoggerMonitorProjectRootDir="\GitHub\Monitor\LoggerMonitor" ^
...
call "C:\Program Files (x86)\WiX Toolset v3.14\bin\Light.exe" -out %appName%.msi ^
-ext "c:\Program Files (x86)\WiX Toolset v3.14\bin\WixUtilExtension.dll" ^
